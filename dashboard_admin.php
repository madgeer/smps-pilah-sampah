...
check_auth('admin'); // Ensure logged in as 'admin'
...
// 2. Fetch Classes & Groups list for Dropdown Filters
$classes_list = [];
$groups_list = [];
try {
...
// 4. Fetch Group (Kelompok) Rankings by Sorted Waste Weight (Grams)
$rankings = [];
try {
    $stmt = $pdo->query("
...
// 5. Fetch Global Logs with dynamic Search, Filtering & Pagination
$logs = [];
$total_rows = 0;
$total_pages = 0;
$limit = 10;
...
$page_title = 'Dashboard Admin - SMPSM';

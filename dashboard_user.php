...
// 2. Fetch dropdown choices (Satuan and Nama Sampah)
try {
    // Satuan
...
// 4. Fetch User Stats (Infobox Style)
...
// 5. Fetch User Report History with Pagination
...
try {
    // Get total rows for pagination calculation
    ...
    ");
    // Bind parameters as integers to prevent SQL syntax errors in prepared statements
...
<head>
    ...
    <title>Dashboard Mahasiswa - SMPSM</title>
...
<body>
    <div class="navbar">
        <h2>SMPSM</h2>
        <div class="nav-links">
            <span class="nav-user-info">Masuk sebagai: <strong><?php echo htmlspecialchars($user['email']); ?></strong> (Mahasiswa)</span>
